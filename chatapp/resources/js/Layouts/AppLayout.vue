<template>
  <div>
    ...
    <div class="min-h-screen bg-gray-100" >
      <nav class="bg-white border-b border-gray-100"   style="background-color:lightseagreen">
      ...
      <!-- Page Heading -->
      <header class="bg-white shadow" v-if="$slots.header"  style="background-color:powderblue">
